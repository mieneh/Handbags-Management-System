                            ...
                            <select id="district" name="district" disabled>
                                ...
                                <?php if (!empty($city)): ?>
                                    <?php foreach ($locations[$city] as $districtName => $wards): ?>
                                        <option value="<?php echo $districtName; ?>" <?php if ($districtName == $district) echo 'selected'; ?>>
                            ...
                            <select id="ward" name="ward" disabled>
                                ...
                                <?php if (!empty($district)): ?>
                                    <?php foreach ($locations[$city][$district] as $wardName): ?>
                                        <option value="<?php echo $wardName; ?>" <?php if ($wardName == $ward) echo 'selected'; ?>>
                                            <?php echo $wardName; ?>
                                        </option>
                                    <?php endforeach; ?>
                                <?php endif; ?>
...
<script>
    ...
    document.getElementById('editBtn').addEventListener('click', function() {
        // Bật các input để chỉnh sửa
        document.querySelectorAll('input, select').forEach(function(input) {
            input.disabled = false;
        });

        // Hiện nút Save, ẩn nút Cập nhật
    ...
    document.getElementById('image').addEventListener('change', function(event) {
        ...
        reader.onload = function() {
            ...
            output.src = reader.result; // Cập nhật ảnh hiển thị
        };
