        ...
        <div class="row">
            ...
            <div class="column right">
                ...
                <div class="order-summary">
                    ...
                    <?php endforeach; ?>
                    <hr>
                    <p>Tạm tính: <span id="total_price"><?php echo number_format($total, 0, ',', '.'); ?> VNĐ</span></p>
                    <p>Phí ship: <span id="shipping_fee">30.000 VNĐ</span></p>
                    <h5>Tổng tiền: <span id="final_total"><?php echo number_format($total + 30000, 0, ',', '.'); ?> VNĐ</span></h5> <!-- Cộng phí ship -->
                </div>
                <!-- Discount code -->
                <div class="form-group">
                    <label for="discount_code">Mã giảm giá</label>
                    <input type="text" id="discount_code" name="discount_code">
                    <button type="button" class="btn">Sử dụng</button>
                </div>
            </div>
        </div>
